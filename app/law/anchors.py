...
#   '퇴직연금제도 + 변경'이 정의·부담금 조문만 잡았다. 전환의 방향별 가부를
#   정한 조문을 아직 못 봤다. 방향이 요점인 규칙이라, 전환 자체를 언급한
#   조문만으로는 앵커가 될 수 없다(수치 없는 조문을 C4에 못 달았던 것과
#   같은 이유). SEARCH_TERMS의 E5·E5_대안으로 재검색할 것.
