...
> 회귀 테스트 1,456건 통과. 자세한 내용은 [PROGRESS.md](PROGRESS.md).
...
| L2 | 함정 감지 (29종) | – | `core/trap_rules.py` |
...
| L5 | 계산 (18종, CALC_REGISTRY) | – | `core/pension_calc_functions.py` |
...
tests/            회귀 테스트 1,456건 + 자체 평가셋 42문항
```
